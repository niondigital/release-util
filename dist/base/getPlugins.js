        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                    ...
                    return [4 /*yield*/, Promise.all(releasePlugins.split(',').map(function (pluginName) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        _a.trys.push([3, 5, , 6]);
                                        return [4 /*yield*/, Promise.resolve().then(function () { return require(path.resolve(String(appRoot), pluginName)); })];
                                    case 4:
                                        pluginModule = _a.sent(); // eslint-disable-line @typescript-eslint/no-var-requires
                                        return [3 /*break*/, 6];
                                    case 5:
                ...
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [2 /*return*/, plugins];
            }
        });
    });
}
